...
from utils.general_utils import strip_symmetric, build_scaling_rotation, get_alternating_gaussians_pose_lrs
...
class GaussianModel:
    ...
    def training_setup(self, training_args):
        ...
        if training_args.alternating_optimization:
            _, self.xyz_scheduler_args = get_alternating_gaussians_pose_lrs(training_args.pose_lr_init, training_args.pose_lr_final,
    ...
    def update_learning_rate(self, iteration):
        ...
        for param_group in self.optimizer.param_groups:
            if param_group["name"] == "xyz":
                if type(self.xyz_scheduler_args) == list:
